            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @endif
                    @else
                        <li class="nav-item"><a class="nav-link" href="{{route('product.shoppingCart')}}" role="button"><i
                                    class="fas fa-shopping-cart"></i>
                                <span class="badge">{{\Illuminate\Support\Facades\Session::has('cart') ?
\Illuminate\Support\Facades\Session::get('cart')->totalQuantity : ''}}</span>
                            </a></li>
